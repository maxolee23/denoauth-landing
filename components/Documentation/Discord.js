...
const Discord = () => {
    return (
        <div className="pt-5" id="linkedin">
            ...
            <Image src={DiscordSnip} alt="LinkedIn" className="rounded"/>
            <h3 className="text-medium font-light text-gray-500 py-5"><strong className="text-black">Step 2:</strong> Use our createLink function to redirect the user to a page to enter their Discord credentials for authorization.</h3>
