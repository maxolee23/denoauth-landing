...
const Github = () => {
    return (
        <div className="pt-10" id="github">
            ...
            <Image src={GithubSnip} alt="Github" className="rounded"/>
            ...
            <Image src={Ghcreatelink} alt="Create Link" className="rounded"/>
            ...
            <Image src={Ghprocess} alt="Process Auth" className="rounded" />
