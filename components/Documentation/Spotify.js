...
const Spotify = () => {
    return (
        <div className="pt-5" id="spotify">
            ...
            <Image src={Spotifysnip} alt="Spotify" className="rounded"/>
            ...
            <Image src={Spotifycl} alt="Create Link" className="rounded"/>
            ...
            <Image src={Spotifypo} alt="Process Auth" className="rounded" />
