    ...
    return (
        <div className="text-center bg-gray-50 py-16">
            ...
            <div className="flex justify-center">
                ...
                <Link href="https://www.producthunt.com/posts/denoauth" passHref><a target="_blank" rel="noreferrer"><div className="border rounded border-indigo-300 px-5 py-3 mx-2 bg-white hover:bg-gray-200 text-xs flex"><FaProductHunt className="w-5 h-5" /><p className="px-2 pt-1 text-xs lg:text-sm">ProductHunt</p></div></a></Link>
            </div>
        </div>
    )
}
