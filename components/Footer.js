      ...
      <div className="max-w-7xl mx-auto py-5 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav className="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
            <div className="px-5 pt-5 flex justify-center">
              <Link href="https://github.com/oslabs-beta/DenOAuth" passHref><a target="_blank" rel="noreferrer" className="text-base text-gray-500 hover:text-gray-900 px-2">
                <FaGithub className="w-5 h-5"/>
              </a>
              </Link>
              <Link href="https://www.linkedin.com/company/denoauth" passHref>
